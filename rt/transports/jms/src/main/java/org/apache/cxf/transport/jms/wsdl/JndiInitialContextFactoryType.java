...
/**
 * <p>Java class for jndiInitialContextFactoryType complex type.
 * 
...
@XmlType(name = "jndiInitialContextFactoryType", propOrder = { "value" })
public class JndiInitialContextFactoryType implements ExtensibilityElement {
